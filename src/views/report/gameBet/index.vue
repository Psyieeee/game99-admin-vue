<template>
  <div class="app-container">
    ...
    <el-button type="primary" icon="Position" size="small" @click="countBettingMembers"
               :disabled="countBettingMembersStatus">获取投注人数
    </el-button>
...
const countBettingMembersStatus = ref(false);
...
const dataInfo = reactive({
  queryParams: {
    ...
    pageSize: 20,
    data: [],
    dateTimeRange: [parseTime((new Date() - 3600 * 1000 * 24), '{y}-{m}-{d}'), parseTime((new Date() - 3600 * 1000 * 24), '{y}-{m}-{d}')],
    gameplame: null
  },
  totalData: {
    total: 0,
