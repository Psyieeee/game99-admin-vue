<template>
  <div class="app-container">
    ...
    <el-descriptions title="Registered Record" :column="3" border>
    ...
    <el-table v-loading="loading" :data="memberReferralList.referralDetails" @selection-change="handleSelectionChange">
