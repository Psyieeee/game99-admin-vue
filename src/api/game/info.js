...
export function listGameInfo(query) {
    return request({
        url: url.game88GameAdminWeb + '/game/info/list',
        method: 'get',
        params: query
    })
}
...
export function listGameInfoAllList(platformId) {
    return request({
        url: url.game88GameAdminWeb + '/game/info/listAll',
        method: 'get',
        params: {
...
export function getGameInfo(id) {
    return request({
        url: url.game88GameAdminWeb + '/game/info/' + id,
        method: 'get'
    })
}
...
export function addGameInfo(data) {
    return request({
        url: url.game88GameAdminWeb + '/game/info',
        method: 'post',
        data: data
    })
}
...
export function changeEffectStatusInfo(id, effect) {
    return request({
        url: url.game88GameAdminWeb + '/game/info/changeEffect/' + id + '/' + effect,
        method: 'put'
    })
}
...
export function changeMaintainStatusInfo(id, maintain) {
    return request({
        url: url.game88GameAdminWeb + '/game/info/changeMaintain/' + id + '/' + maintain,
        method: 'put'
    })
}
...
export function changeRecommendStatusInfo(id, recommend) {
    return request({
        url: url.game88GameAdminWeb + '/game/info/changeRecommend/' + id + '/' + recommend,
        method: 'put'
    })
}